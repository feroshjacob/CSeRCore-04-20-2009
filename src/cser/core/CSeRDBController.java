...
public class CSeRDBController {
	...
	public static void createClonePair(IFile file, IFile file1)
			throws CSeRException {

		createClonePair(file, file1, null, null);

	}
	
	public static void createClonePair(IFile file)
	throws CSeRException {
        ...
        if(file1!=null){
        	createClonePair(file1, file, null, null);        	
        }
